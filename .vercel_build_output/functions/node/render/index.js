...
// .svelte-kit/output/server/chunks/index-35715a94.js
function run(fn) {
  return fn();
}
...
var css$3, Header, css$2, Footer, css$1, Transition, css, load, _layout;
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/__layout.svelte.js"() {
    init_index_35715a94();
    css$3 = {
      code: "header.svelte-ri8kyo.svelte-ri8kyo{position:fixed;width:100%;display:flex;justify-content:space-between;background:linear-gradient(\n      to bottom,\n      var(--dark-hover) calc(25% + var(--space-2)),\n      transparent calc(25% + var(--space-1))\n    );z-index:1;-webkit-appearance:none}a#logo.svelte-ri8kyo.svelte-ri8kyo{position:relative;display:inline-block;padding:var(--space-1) 4rem var(--space-1) var(--space-1);overflow:hidden;color:var(--dark)}a#logo.svelte-ri8kyo.svelte-ri8kyo:after{content:'';position:absolute;top:0;left:0;width:100%;height:100%;background:var(--dark-hover);-webkit-transform-origin:100% 0;-ms-transform-origin:100% 0;transform-origin:100% 0;-webkit-transform:skew(-20deg);-ms-transform:skew(-20deg);transform:skew(-20deg);z-index:1}img.svelte-ri8kyo.svelte-ri8kyo{width:100%;max-width:clamp(200px, 100px, 100vw);height:auto;filter:invert(100%);position:relative;z-index:2}ul.svelte-ri8kyo.svelte-ri8kyo{display:flex;justify-content:flex-end;gap:calc(var(--space-1) / 2);padding:var(--space-1)}li.svelte-ri8kyo.svelte-ri8kyo{color:var(--light)}a.svelte-ri8kyo.svelte-ri8kyo{text-decoration:none;color:inherit}li.svelte-ri8kyo.svelte-ri8kyo{display:none}#mobile-trigger.svelte-ri8kyo.svelte-ri8kyo{display:inline-block}#mobile-menu.svelte-ri8kyo.svelte-ri8kyo{position:absolute;transform:translate3d(0, -100%, 0);transition:transform 250ms ease-out;left:0;width:100%;display:flex;flex-direction:column;justify-content:center;align-items:center;gap:var(--space-1);padding:var(--space-1) 0rem var(--space-1) 0rem;background:var(--dark-hover);border-bottom:2px var(--light) solid;color:var(--light);z-index:3}#mobile-menu.svelte-ri8kyo button.svelte-ri8kyo{align-self:flex-end;margin-right:var(--space-1)}#mobile-menu.open.svelte-ri8kyo.svelte-ri8kyo{position:absolute;transform:translate3d(0, 0, 0);top:0}@media(min-width: 768px){#mobile-menu.svelte-ri8kyo.svelte-ri8kyo{display:none}li.svelte-ri8kyo.svelte-ri8kyo{display:inline-block}#mobile-trigger.svelte-ri8kyo.svelte-ri8kyo{display:none}}button.svelte-ri8kyo.svelte-ri8kyo{background:none;border:none;outline:none;cursor:pointer;color:var(--light)}",
      map: null
    };
    Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css$3);
      return `<header class="${"svelte-ri8kyo"}"><a href="${"/"}" id="${"logo"}" class="${"svelte-ri8kyo"}"><img src="${"/header-logo.png"}" alt="${"Kelsey Lea Photography"}" class="${"svelte-ri8kyo"}"></a>
  <ul class="${"svelte-ri8kyo"}"><li class="${"svelte-ri8kyo"}"><a href="${"/"}" class="${"svelte-ri8kyo"}">Home</a></li>
    <li class="${"svelte-ri8kyo"}">\u2022</li>
    <li class="${"svelte-ri8kyo"}"><a href="${"/gallery"}" class="${"svelte-ri8kyo"}">Gallery</a></li>
    <li class="${"svelte-ri8kyo"}">\u2022</li>
    <li class="${"svelte-ri8kyo"}"><a href="${"/packages"}" class="${"svelte-ri8kyo"}">Packages</a></li>

    <li id="${"mobile-trigger"}" class="${"svelte-ri8kyo"}"><button class="${"svelte-ri8kyo"}">Menu </button></li></ul>

  <div id="${"mobile-menu"}" class="${["svelte-ri8kyo", ""].join(" ").trim()}"><a href="${"/"}" class="${"svelte-ri8kyo"}"><img src="${"/header-logo.png"}" alt="${"Kelsey Lea Photography"}" class="${"svelte-ri8kyo"}"></a>
    <a href="${"/"}" class="${"svelte-ri8kyo"}">Home</a>
    <a href="${"/gallery"}" class="${"svelte-ri8kyo"}">Gallery</a>
    <a href="${"/packages"}" class="${"svelte-ri8kyo"}">Packages</a>

    <button class="${"svelte-ri8kyo"}">Close </button></div>
</header>`;
    });
    css$2 = {
      code: "footer.svelte-msgrn.svelte-msgrn{background:var(--dark);color:var(--light);display:grid;place-items:center}footer.svelte-msgrn>div.svelte-msgrn{display:grid;grid-template-areas:'nav'\n      'copy'\n      'credit';justify-content:center;justify-items:center;gap:var(--space-2);padding:var(--space-2);max-width:var(--content-max-width)}#nav.svelte-msgrn.svelte-msgrn{grid-area:nav;color:inherit;display:flex;align-items:center;gap:1rem}#nav.svelte-msgrn a.svelte-msgrn{text-decoration:none}#nav.svelte-msgrn a.svelte-msgrn:hover,#nav.svelte-msgrn a.svelte-msgrn:focus{text-decoration:underline}p#credit.svelte-msgrn.svelte-msgrn{grid-area:credit}p#credit.svelte-msgrn a.svelte-msgrn{font-weight:bold;text-decoration:none}div#copy.svelte-msgrn.svelte-msgrn{grid-area:copy;display:flex;flex-direction:column;justify-content:center;margin-top:var(--space-3);gap:var(--space-1)}div#copy.svelte-msgrn img.svelte-msgrn{width:clamp(100px, var(--space-2), var(--space-6));filter:invert(100%);vertical-align:middle}@media(min-width: 768px){footer.svelte-msgrn>div.svelte-msgrn{grid-template-areas:unset;grid-template-columns:1fr 1fr 1fr;grid-template-rows:1fr;align-content:center;align-items:center;justify-content:center;justify-items:center;gap:var(--space-6)}div#copy.svelte-msgrn.svelte-msgrn{flex-direction:row;justify-content:center;align-items:center;margin-top:unset;gap:var(--space-1)}#nav.svelte-msgrn.svelte-msgrn{grid-area:unset}p#credit.svelte-msgrn.svelte-msgrn{grid-area:unset}div#copy.svelte-msgrn.svelte-msgrn{grid-area:unset}}",
      map: null
    };
    Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css$2);
      return `<footer class="${"svelte-msgrn"}"><div class="${"svelte-msgrn"}"><div id="${"copy"}" class="${"svelte-msgrn"}"><p>\xA9 Images by</p>
      <a href="${"/"}"><img src="${"/footer-logo.png"}" alt="${"logo"}" class="${"svelte-msgrn"}"></a></div>
    <ul id="${"nav"}" class="${"svelte-msgrn"}"><li><a href="${"/"}" class="${"svelte-msgrn"}">Home</a></li>
      <li>\u2022</li>
      <li><a href="${"/gallery"}" class="${"svelte-msgrn"}">Gallery</a></li>
      <li>\u2022</li>
      <li><a href="${"/packages"}" class="${"svelte-msgrn"}">Packages</a></li></ul>
    <p id="${"credit"}" class="${"svelte-msgrn"}">Site by <a href="${"https://ca.linkedin.com/in/austin-mcphail"}" class="${"svelte-msgrn"}">McPhail.dev</a></p></div>
</footer>`;
    });
    css$1 = {
      code: ".transition-outer.svelte-1eq9obb{display:grid;grid-template:1fr 1fr}.transition-inner.svelte-1eq9obb{grid-row:1;grid-column:1}",
      map: null
    };
    Transition = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<div class="${"transition-outer svelte-1eq9obb"}"><div class="${"transition-inner svelte-1eq9obb"}">${slots.default ? slots.default({}) : ``}</div>
</div>`;
    });
    css = {
      code: "div.svelte-1a1siqi{display:flex;flex-direction:column;min-height:100vh}main.svelte-1a1siqi{flex:1}",
      map: null
    };
    load = async ({ url }) => ({ props: { url: url.href } });
    _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { url } = $$props;
      if ($$props.url === void 0 && $$bindings.url && url !== void 0)
        $$bindings.url(url);
      $$result.css.add(css);
      return `${$$result.head += `${$$result.title = `<title>Kelsey Lea Photography</title>`, ""}`, ""}
${validate_component(Header, "Header").$$render($$result, {}, {}, {})}

<div class="${"svelte-1a1siqi"}"><main class="${"svelte-1a1siqi"}">${validate_component(Transition, "Transition").$$render($$result, { url }, {}, {
        default: () => {
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    init_layout_svelte();
    entry = "pages/__layout.svelte-3462f572.js";
    js = ["pages/__layout.svelte-3462f572.js", "chunks/index-085ef875.js", "chunks/Transition-5c95ae33.js", "chunks/index-e69c8483.js"];
    css2 = ["assets/pages/__layout.svelte-864fa557.css", "assets/Transition-47ce6e48.css"];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    init_error_svelte();
    entry2 = "error.svelte-3ead7297.js";
    js2 = ["error.svelte-3ead7297.js", "chunks/index-085ef875.js"];
    css3 = [];
  }
});
...
var require_observable2 = __commonJS({
  "node_modules/@sanity/client/lib/util/observable.js"(exports, module2) {
    "use strict";
...
var require_url_parse = __commonJS({
  "node_modules/url-parse/index.js"(exports, module2) {
    ...
    function Url(address, location, parser) {
      ...
      var relative, extracted, parse2, instruction, index, key2, instructions = rules.slice(), type = typeof location, url = this, i2 = 0;
  ...
  "node_modules/@sanity/client/lib/assets/assetsClient.js"(exports, module2) {
    ...
    assign(AssetsClient.prototype, {
      ...
      getImageUrl: function getImageUrl(ref, query) {
        ...
        return "https://cdn.sanity.io/images/".concat(projectId2, "/").concat(dataset2, "/").concat(assetId, "-").concat(size, ".").concat(format2).concat(qs);
      }
    });
  ...
  "node_modules/follow-redirects/index.js"(exports, module2) {
    ...
    RedirectableRequest.prototype._performRequest = function() {
      ...
      if (this._options.agents) {
        var scheme2 = protocol.slice(0, -1);
    ...
    function wrap(protocols) {
      ...
      Object.keys(protocols).forEach(function(scheme2) {
        ...
        function get6(input, options, callback) {
        ...
        Object.defineProperties(wrappedProtocol, {
          ...
          get: { value: get6, configurable: true, enumerable: true, writable: true }
        });
      });
      return exports2;
    }
...
var require_lib_node = __commonJS({
  "node_modules/get-it/lib-node/index.js"(exports, module2) {
    ...
    module2.exports = function createRequester(initMiddleware = [], httpRequest = httpRequester) {
  ...
  "node_modules/@sanity/image-url/lib/node/builder.js"(exports) {
    ...
    function rewriteSpecName(key2) {
      ...
      for (var _i = 0, specs_1 = specs; _i < specs_1.length; _i++) {
        var entry5 = specs_1[_i];
        var specName = entry5[0], param = entry5[1];
    ...
    function urlBuilder(options) {
      ...
      if (isSanityClientLike(client2)) {
        var _a = client2.clientConfig, apiUrl = _a.apiHost, projectId2 = _a.projectId, dataset2 = _a.dataset;
    ...
    var ImageUrlBuilder = function() {
      ...
      ImageUrlBuilder2.prototype.focalPoint = function(x2, y) {
        return this.withOptions({ focalPoint: { x: x2, y } });
      };
...
// .svelte-kit/output/server/chunks/sanityClient-6c25bbf7.js
var import_client, import_image_url, api, projectId, dataset, client, builder, urlFor;
var init_sanityClient_6c25bbf7 = __esm({
  ".svelte-kit/output/server/chunks/sanityClient-6c25bbf7.js"() {
    import_client = __toESM(require_sanityClient(), 1);
    import_image_url = __toESM(require_node5(), 1);
    api = {
      projectId: "tgdufnkq",
      dataset: "production"
    };
    ({ projectId, dataset } = api);
...
// .svelte-kit/output/server/chunks/SanityImage-128375dd.js
var SanityImage;
var init_SanityImage_128375dd = __esm({
  ".svelte-kit/output/server/chunks/SanityImage-128375dd.js"() {
    init_index_35715a94();
    init_sanityClient_6c25bbf7();
    SanityImage = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      var _a, _b;
      let dimensions;
      let { image } = $$props;
      let { maxWidth = 1200 } = $$props;
      let { maxHeight = 1200 } = $$props;
      ...
      dimensions = (_b = (_a = image == null ? void 0 : image.asset) == null ? void 0 : _a._ref) == null ? void 0 : _b.split("-")[2];
      dimensions.split("x").map(Number);
      return `${image ? `<img loading="${"lazy"}"${add_attribute("src", urlFor(image).width(maxWidth).height(maxHeight).fit("fillmax"), 0)}${add_attribute("alt", alt || image.alt || "", 0)} style="${"opacity: " + escape(0) + "; transition: .2s opacity;" + escape(styles) + "; --image-url: url('$" + escape(urlFor(image).width(maxWidth).height(maxHeight).fit("fillmax")) + "')"}"${add_attribute("class", `sanity-img ${classes}`, 0)}>` : ``}`;
    });
  }
});

// .svelte-kit/output/server/chunks/PageTitle-ee4bbc70.js
var css4, PageTitle;
var init_PageTitle_ee4bbc70 = __esm({
  ".svelte-kit/output/server/chunks/PageTitle-ee4bbc70.js"() {
    init_index_35715a94();
    css4 = {
      code: "section.svelte-rh9g51{display:grid;place-items:center;padding-block:var(--space-10);padding-inline:var(--space-2);color:var(--dark);box-shadow:var(--shadow-25)}h2.svelte-rh9g51{font-size:var(--font-largest);font-weight:bold;margin-block:var(--space-2);text-align:center}p.svelte-rh9g51{font-family:var(--font-accent);font-size:var(--font-large);text-align:center}p.subtitle.svelte-rh9g51{font-family:var(--font);font-size:var(--font-large);color:var(--dark-50);text-align:center;margin-bottom:var(--space-2)}",
      map: null
    };
    PageTitle = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$result.css.add(css4);
      return `<section class="${"svelte-rh9g51"}"><h2 class="${"svelte-rh9g51"}">${escape(title)}</h2>
  ${subtitle ? `<p class="${"subtitle svelte-rh9g51"}">${escape(subtitle)}</p>` : ``}
  ${quote ? `<p class="${"svelte-rh9g51"}">${escape(quote)}</p>` : ``}
</section>`;
    });
  }
});

// .svelte-kit/output/server/entries/pages/gallery/_album_/index.svelte.js
var index_svelte_exports = {};
__export(index_svelte_exports, {
  default: () => U5Balbumu5D,
  load: () => load3
});
async function load3({ params, fetch: fetch3 }) {
  try {
    const url = `/gallery/${params.album}/${params.album}.json`;
    const res = await fetch3(url);
    const data = await res.json();
    if (data == null ? void 0 : data.album) {
      return { props: data.album };
    }
  } catch (err) {
    return {
      status: 500,
...
var import_client2, css5, Album, U5Balbumu5D;
var init_index_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/gallery/_album_/index.svelte.js"() {
    init_index_35715a94();
    init_SanityImage_128375dd();
    init_PageTitle_ee4bbc70();
    init_sanityClient_6c25bbf7();
    import_client2 = __toESM(require_sanityClient(), 1);
    css5 = {
      code: ".no-images.svelte-6oxrfu{text-align:center;line-height:var(--font-largest)}section.svelte-6oxrfu{margin-top:var(--space-2);padding-bottom:var(--space-5);padding-inline:var(--space-2)}.grid-wrapper.svelte-6oxrfu{display:flex;flex-wrap:wrap;gap:var(--space-1);justify-content:center}div.img.svelte-6oxrfu{cursor:pointer;max-width:500px}div.img.svelte-6oxrfu .sanity-img{width:100%;object-fit:contain;border-radius:5px}div.fullscreen.svelte-6oxrfu{position:fixed;top:0;left:0;height:100vh;width:100vw;padding:var(--space-1);display:grid;place-items:center;z-index:0;background:var(--dark-hover)}div.fullscreen.svelte-6oxrfu .sanity-img{height:95vh;object-fit:contain;border-radius:5px}button.svelte-6oxrfu{position:fixed;bottom:0;right:0;z-index:9999;margin:var(--space-1);padding:var(--space-1);background:var(--dark);border:none;color:var(--light);font-size:var(--font-large);cursor:pointer}button.svelte-6oxrfu:hover,button.svelte-6oxrfu:hover{background:var(--dark-50)}",
      map: null
    };
    Album = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { photos = [] } = $$props;
      onDestroy(() => {
      });
      ...
      $$result.css.add(css5);
      return `${``}
<section class="${"svelte-6oxrfu"}">${photos && photos.length ? `<div class="${"grid-wrapper svelte-6oxrfu"}">${each(photos, (p) => {
        return `<div class="${escape(null_to_empty("img")) + " svelte-6oxrfu"}">${validate_component(SanityImage, "SanityImage").$$render($$result, { image: p.image }, {}, {})}
        </div>`;
      })}</div>` : ``}

  ${!photos.length ? `<div class="${"no-images svelte-6oxrfu"}"><p>This album doesn&#39;t have any photos currently.</p>
      <p><strong>Check back later!</strong></p></div>` : ``}
</section>`;
    });
    U5Balbumu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { name } = $$props;
      let { photos } = $$props;
      let { quote } = $$props;
      ...
      if ($$props.quote === void 0 && $$bindings.quote && quote !== void 0)
        $$bindings.quote(quote);
      return `${$$result.head += `${$$result.title = `<title>Kelsey Lea Photography | Gallery | ${escape(name)}</title>`, ""}`, ""}

${validate_component(PageTitle, "PageTitle").$$render($$result, { title: name, subtitle: "Gallery", quote }, {}, {})}
${validate_component(Album, "Album").$$render($$result, { photos }, {}, {})}`;
    });
  }
});
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    init_index_svelte();
    entry3 = "pages/gallery/_album_/index.svelte-d6b9429f.js";
    js3 = ["pages/gallery/_album_/index.svelte-d6b9429f.js", "chunks/index-085ef875.js", "chunks/SanityImage-3c8bd2b6.js", "chunks/sanityClient-c27f389e.js", "chunks/PageTitle-432aa8d1.js"];
    css6 = ["assets/pages/gallery/_album_/index.svelte-76b3c571.css", "assets/PageTitle-dabe91be.css"];
  }
});

// .svelte-kit/output/server/chunks/Contact-2edaeada.js
var css7, Contact;
var init_Contact_2edaeada = __esm({
  ".svelte-kit/output/server/chunks/Contact-2edaeada.js"() {
    init_index_35715a94();
    css7 = {
      code: "p.svelte-5xolzm.svelte-5xolzm{text-align:center}section.svelte-5xolzm.svelte-5xolzm{padding-top:var(--space-5);background-color:var(--light);color:var(--dark)}@media(min-width: 768px){section.svelte-5xolzm.svelte-5xolzm{display:flex;justify-content:center}section.svelte-5xolzm>div.svelte-5xolzm{max-width:var(--content-max-width);margin:auto}}section.svelte-5xolzm.svelte-5xolzm{padding-inline:var(--space-2)}textarea.svelte-5xolzm.svelte-5xolzm{resize:none}section#contact.svelte-5xolzm.svelte-5xolzm{display:flex;flex-direction:column;align-items:center}section#contact.svelte-5xolzm p.svelte-5xolzm{margin-block:var(--space-2);font-size:var(--font-larger);font-family:var(--font-accent);text-align:center}section#contact.svelte-5xolzm form.svelte-5xolzm{clear:both;display:grid;gap:var(--space-1);padding-inline:var(--space-2)}form.svelte-5xolzm label.svelte-5xolzm{display:none}form.svelte-5xolzm input.svelte-5xolzm,form.svelte-5xolzm textarea.svelte-5xolzm{display:block;padding:1rem;border-radius:var(--br);border:none;-webkit-appearance:none;box-shadow:var(--shadow-inset-25)}form.svelte-5xolzm button.svelte-5xolzm{cursor:pointer;border:none;font-family:var(--font-accent);background:var(--dark);color:var(--light);padding:var(--space-1);border-radius:var(--br);-webkit-appearance:none;box-shadow:var(--shadow-25);transition:all 250ms ease-in-out}form.svelte-5xolzm button.svelte-5xolzm:hover,form.svelte-5xolzm button.svelte-5xolzm:focus{outline:none;background:var(--dark-hover)}form.svelte-5xolzm button.svelte-5xolzm:active{outline:none;background:var(--dark-active)}",
      map: null
    };
    Contact = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { subject = "Photography Shoot" } = $$props;
      let { inbox = "2fd9fd50d27e05dc170e70b73535c011" } = $$props;
      if ($$props.subject === void 0 && $$bindings.subject && subject !== void 0)
        $$bindings.subject(subject);
      if ($$props.inbox === void 0 && $$bindings.inbox && inbox !== void 0)
        $$bindings.inbox(inbox);
      $$result.css.add(css7);
      return `<section class="${"svelte-5xolzm"}"><div class="${"svelte-5xolzm"}"><p class="${"svelte-5xolzm"}"><strong>Check out my work</strong> and <strong>get in touch</strong> with <br> me to schedule
      your shoot today.
    </p></div></section>
<section id="${"contact"}" class="${"svelte-5xolzm"}"><div class="${"svelte-5xolzm"}"><form action="${"https://formsubmit.co/" + escape(inbox)}" method="${"POST"}" id="${"contactform"}" class="${"svelte-5xolzm"}"><label for="${"name"}" class="${"svelte-5xolzm"}">Name</label>
      <input type="${"text"}" class="${"form-control svelte-5xolzm"}" id="${"name"}" name="${"name"}" placeholder="${"Name"}">

      <label for="${"email"}" class="${"svelte-5xolzm"}">Email</label>
      <input type="${"email"}" class="${"form-control svelte-5xolzm"}" id="${"email"}" name="${"email"}" placeholder="${"Email"}">

      <label for="${"message"}" class="${"svelte-5xolzm"}">Message</label>
      <textarea class="${"form-control svelte-5xolzm"}" id="${"message"}" name="${"message"}" rows="${"3"}" placeholder="${"Write your message here..."}"></textarea>

      <input type="${"hidden"}" name="${"_next"}" value="${"http://localhost:3000/thank-you"}" class="${"svelte-5xolzm"}">
      ${subject ? `<input type="${"hidden"}" name="${"_subject"}"${add_attribute("value", subject, 0)} class="${"svelte-5xolzm"}">` : ``}
      <input type="${"text"}" name="${"_honey"}" style="${"display:none"}" class="${"svelte-5xolzm"}">
      <input type="${"hidden"}" name="${"_captcha"}" value="${"false"}" class="${"svelte-5xolzm"}">
      <input type="${"hidden"}" name="${"_template"}" value="${"box"}" class="${"svelte-5xolzm"}">
      <button type="${"submit"}" class="${"btn btn-primary svelte-5xolzm"}">Send</button></form>

    <p class="${"svelte-5xolzm"}">Thank you for visiting my small town prairie portfolio!</p></div>
</section>`;
    });
  }
});

// .svelte-kit/output/server/entries/pages/packages/_pack_/index.svelte.js
var index_svelte_exports2 = {};
__export(index_svelte_exports2, {
  default: () => U5Bpacku5D,
  load: () => load4
});
async function load4({ params, fetch: fetch3 }) {
  try {
    const url = `/packages/${params.pack}/${params.pack}.json`;
    const res = await fetch3(url);
    const data = await res.json();
    if (data == null ? void 0 : data.pack) {
      return { props: data.pack };
    }
  } catch (err) {
    return {
      status: 500,
...
var import_client3, css$22, FAQ, css$12, PackageAddons, css8, PackageFeatures, Package, U5Bpacku5D;
var init_index_svelte2 = __esm({
  ".svelte-kit/output/server/entries/pages/packages/_pack_/index.svelte.js"() {
    init_index_35715a94();
    init_sanityClient_6c25bbf7();
    init_Contact_2edaeada();
    init_PageTitle_ee4bbc70();
    import_client3 = __toESM(require_sanityClient(), 1);
    css$22 = {
      code: "section.svelte-1bi2sss.svelte-1bi2sss{display:flex;justify-content:center;background:var(--light);box-shadow:var(--shadow-inset);color:var(--dark);margin-bottom:var(--space-2)}button.svelte-1bi2sss.svelte-1bi2sss{background:none;border:none;cursor:pointer}.active.svelte-1bi2sss.svelte-1bi2sss{font-weight:bold;text-decoration:underline}section.svelte-1bi2sss>div.svelte-1bi2sss{max-width:var(--content-max-width);display:flex;flex-direction:column;align-items:center}.questions.svelte-1bi2sss.svelte-1bi2sss{display:grid;grid-template-columns:1fr 1fr;gap:var(--space-4)}h3.svelte-1bi2sss.svelte-1bi2sss{text-align:center;font-size:var(--font-larger);margin-top:var(--space-4);font-weight:bold}h4.svelte-1bi2sss.svelte-1bi2sss{text-align:center;font-size:var(--font-normal);margin-bottom:var(--space-2);color:var(--dark-50)}.answer.svelte-1bi2sss.svelte-1bi2sss{text-align:center;margin-top:var(--space-2);margin-bottom:var(--space-2);padding:var(--space-2);max-width:var(--space-20);height:100px;overflow-y:auto}@media(min-width: 768px){}",
      map: null
    };
    FAQ = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.qas === void 0 && $$bindings.qas && qas !== void 0)
        $$bindings.qas(qas);
      $$result.css.add(css$22);
      return `<section class="${"svelte-1bi2sss"}"><div class="${"svelte-1bi2sss"}"><h3 class="${"svelte-1bi2sss"}">FAQ</h3>
    <h4 class="${"svelte-1bi2sss"}">Frequently Asked <br> Questions</h4>
    <div class="${"questions svelte-1bi2sss"}">${each(qas, (qa) => {
        return `<button class="${["svelte-1bi2sss", question === qa.question ? "active" : ""].join(" ").trim()}">${escape(qa.question)}
        </button>`;
      })}</div>
    ${``}</div>
</section>`;
    ...
    css$12 = {
      code: "section.svelte-mimhkv.svelte-mimhkv{display:flex;justify-content:center;background:var(--light);box-shadow:var(--shadow-inset-top), var(--shadow-25);color:var(--dark)}section.svelte-mimhkv>div.svelte-mimhkv{max-width:var(--content-max-width);display:flex;flex-direction:column;align-items:center}.addons.svelte-mimhkv.svelte-mimhkv{display:grid;grid-template-columns:1fr}ul.svelte-mimhkv.svelte-mimhkv{display:flex;flex-direction:column;gap:1rem;list-style:disc;padding-inline:var(--space-2);list-style-position:inside}ul.svelte-mimhkv.svelte-mimhkv:is(:last-child){margin-top:1rem}h3.svelte-mimhkv.svelte-mimhkv{text-align:center;margin-top:var(--space-4);margin-bottom:var(--space-2);font-weight:bold}.blurb.svelte-mimhkv.svelte-mimhkv{text-align:center;margin-top:var(--space-2);margin-bottom:var(--space-4);padding-inline:var(--space-2);max-width:var(--space-20)}@media(min-width: 768px){.addons.svelte-mimhkv.svelte-mimhkv{gap:var(--space-2);grid-template-columns:1fr 1fr}ul.svelte-mimhkv.svelte-mimhkv{margin-block:var(--space-2)}}",
      map: null
    };
    PackageAddons = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let firstHalfOfAddons;
      let secondHalfOfAddons;
      let { addons = [] } = $$props;
      let { blurb = "" } = $$props;
      if ($$props.addons === void 0 && $$bindings.addons && addons !== void 0)
        $$bindings.addons(addons);
      ...
      return `<section class="${"svelte-mimhkv"}"><div class="${"svelte-mimhkv"}"><h3 class="${"svelte-mimhkv"}">Addons &amp; Extras</h3>
    ${(addons == null ? void 0 : addons.length) ? `<div class="${"addons svelte-mimhkv"}"><ul class="${"svelte-mimhkv"}">${each(firstHalfOfAddons, (addon) => {
        return `<li><span>${escape(addon)}</span>
            </li>`;
      })}</ul>
        <ul class="${"svelte-mimhkv"}">${each(secondHalfOfAddons, (addon) => {
        return `<li><span>${escape(addon)}</span>
            </li>`;
      })}</ul></div>` : ``}
    ${blurb ? `<p class="${"blurb svelte-mimhkv"}">${escape(blurb)}</p>` : ``}</div>
</section>`;
    });
    css8 = {
      code: ".img.svelte-23pstq{background-image:var(--previewImage);width:100%;height:100%;background-position:center;background-repeat:no-repeat;background-size:cover}p.svelte-23pstq{font-family:var(--font-accent);font-size:var(--font-large);text-align:center}h3.svelte-23pstq{font-size:var(--font-largest);font-weight:bold;margin-block:var(--space-2);text-align:center}ul.svelte-23pstq{display:flex;flex-direction:column;text-align:center;list-style:circle;padding-inline:var(--space-2);margin-block:var(--space-2);gap:1rem}li.svelte-23pstq{list-style-position:inside}.content.svelte-23pstq{padding:var(--space-2)}section.features.svelte-23pstq{display:grid;align-items:center;grid-template-columns:1fr;grid-template-rows:1fr 2fr 1fr;background:var(--dark);color:var(--light);box-shadow:var(--shadow-inset-top)}@media(min-width: 768px){section.features.svelte-23pstq{grid-template-columns:1fr 2fr 1fr;grid-template-rows:1fr}}",
      map: null
    };
    PackageFeatures = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { previewImageOne } = $$props;
      let { previewImageTwo } = $$props;
      let { cost } = $$props;
      let { features = [] } = $$props;
      const previewImageOneUrl = urlFor(previewImageOne).url();
      const previewImageTwoUrl = urlFor(previewImageTwo).url();
      if ($$props.previewImageOne === void 0 && $$bindings.previewImageOne && previewImageOne !== void 0)
        $$bindings.previewImageOne(previewImageOne);
      if ($$props.previewImageTwo === void 0 && $$bindings.previewImageTwo && previewImageTwo !== void 0)
        $$bindings.previewImageTwo(previewImageTwo);
      ...
      $$result.css.add(css8);
      return `<section class="${"features svelte-23pstq"}"><div class="${"img svelte-23pstq"}"${add_attribute("style", `--previewImage: url("${previewImageOneUrl}");`, 0)}></div>
  <div class="${"content svelte-23pstq"}"><p class="${"svelte-23pstq"}">Starting at</p>
    <h3 class="${"svelte-23pstq"}">${escape(cost)}</h3>
    <ul class="${"svelte-23pstq"}">${each(features, (feature) => {
        return `<li class="${"svelte-23pstq"}">${escape(feature)}</li>`;
      })}</ul></div>
  <div class="${"img svelte-23pstq"}"${add_attribute("style", `--previewImage: url("${previewImageTwoUrl}");`, 0)}></div>
</section>`;
    });
    Package = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.title === void 0 && $$bindings.title && title !== void 0)
        $$bindings.title(title);
      return `${validate_component(PackageFeatures, "PackageFeatures").$$render($$result, {
        previewImageOne,
        previewImageTwo,
        cost,
        features
      }, {}, {})}
${(addons == null ? void 0 : addons.length) || blurb ? `${validate_component(PackageAddons, "PackageAddons").$$render($$result, { addons, blurb }, {}, {})}` : ``}
${validate_component(FAQ, "FAQ").$$render($$result, { qas: faq }, {}, {})}
${validate_component(Contact, "Contact").$$render($$result, { subject: "Photography Shoot: " + title }, {}, {})}`;
    });
    U5Bpacku5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { title } = $$props;
      let { quote } = $$props;
      let { cost } = $$props;
      let { blurb } = $$props;
...
${validate_component(Package, "Package").$$render($$result, {
        title,
        blurb,
        previewImageOne,
        previewImageTwo,
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/5.js"() {
    init_index_svelte2();
    entry4 = "pages/packages/_pack_/index.svelte-ab051fc2.js";
    js4 = ["pages/packages/_pack_/index.svelte-ab051fc2.js", "chunks/index-085ef875.js", "chunks/Transition-5c95ae33.js", "chunks/index-e69c8483.js", "chunks/sanityClient-c27f389e.js", "chunks/Contact-d06e8274.js", "chunks/PageTitle-432aa8d1.js"];
    css9 = ["assets/pages/packages/_pack_/index.svelte-685d70d7.css", "assets/Transition-47ce6e48.css", "assets/Contact-28b322a7.css", "assets/PageTitle-dabe91be.css"];
  }
});

// .svelte-kit/output/server/chunks/queries-ee58dbf2.js
function getPhotosQuery(extraFilter) {
  return `*[
    _type == "photo" &&
    publishedAt < now()
...
function getJumbotronPhotosQuery() {
  return `*[
    _type == "photo" &&
    publishedAt < now() &&
    showOnHome == true && 
...
function getAlbumsQuery(extraFilter) {
  return `*[
    _type == "album" &&
...
function getPackagesQuery(extraFilter) {
  return `*[
    _type == "package" &&
    defined(slug.current) 
    ${extraFilter ? `&& ${extraFilter}` : ""}
...
var init_queries_ee58dbf2 = __esm({
  ".svelte-kit/output/server/chunks/queries-ee58dbf2.js"() {
  }
});

// .svelte-kit/output/server/entries/endpoints/jumbotron.json.js
var jumbotron_json_exports = {};
__export(jumbotron_json_exports, {
  get: () => get
});
async function get() {
...
var import_client4;
var init_jumbotron_json = __esm({
  ".svelte-kit/output/server/entries/endpoints/jumbotron.json.js"() {
    init_queries_ee58dbf2();
    init_sanityClient_6c25bbf7();
    import_client4 = __toESM(require_sanityClient(), 1);
  }
});

// .svelte-kit/output/server/entries/endpoints/packages/packages.json.js
var packages_json_exports = {};
__export(packages_json_exports, {
  get: () => get2
});
async function get2() {
...
// .svelte-kit/output/server/entries/endpoints/gallery/gallery.json.js
var gallery_json_exports = {};
__export(gallery_json_exports, {
  get: () => get3
});
async function get3() {
  const data = await client.fetch(`{
...
// .svelte-kit/output/server/entries/endpoints/packages/_pack_/_pack_.json.js
var pack_json_exports = {};
__export(pack_json_exports, {
  get: () => get4
});
async function get4({ params: { pack } }) {
  const pckg = (await client.fetch(`{
...
// .svelte-kit/output/server/entries/endpoints/gallery/_album_/_album_.json.js
var album_json_exports = {};
__export(album_json_exports, {
  get: () => get5
});
async function get5({ params: { album } }) {
  const alb = (await client.fetch(`{
...
async function load_shadow_data(route, event, options, prerender) {
  ...
  try {
    ...
    const get6 = method === "head" && mod.head || mod.get;
    if (get6) {
      const result = await get6(event);
      if (result.fallthrough) {
        throw new Error("fallthrough is no longer supported. Use matchers instead: https://kit.svelte.dev/docs/routing#advanced-routing-matching");
      }
      const { status, headers, body } = validate_shadow_output(result);
...
var manifest = {
  appDir: "_app",
  assets: /* @__PURE__ */ new Set([".DS_Store", "favicon.png", "footer-logo.png", "header-logo.png", "reset.css", "temp/child.jpeg", "temp/cows.jpeg", "temp/family-dog.jpeg", "temp/family.jpeg", "temp/lake.jpeg", "temp/portrait.jpeg", "temp/rock.jpeg", "temp/wine.jpeg", "temp/woman.jpeg"]),
  mimeTypes: { ".png": "image/png", ".css": "text/css", ".jpeg": "image/jpeg" },
  _: {
    entry: { "file": "start-dd1c1d02.js", "js": ["start-dd1c1d02.js", "chunks/index-085ef875.js"], "css": [] },
    nodes: [
    ...
    routes: [
      {
        type: "endpoint",
        id: "jumbotron.json",
        pattern: /^\/jumbotron\.json$/,
        names: [],
        types: [],
        load: () => Promise.resolve().then(() => (init_jumbotron_json(), jumbotron_json_exports))
      },
      {
        type: "endpoint",
        id: "packages/packages.json",
        pattern: /^\/packages\/packages\.json$/,
        names: [],
        types: [],
        load: () => Promise.resolve().then(() => (init_packages_json(), packages_json_exports))
      },
      {
        type: "endpoint",
        id: "gallery/gallery.json",
        pattern: /^\/gallery\/gallery\.json$/,
        names: [],
        types: [],
        load: () => Promise.resolve().then(() => (init_gallery_json(), gallery_json_exports))
      },
      {
        type: "page",
        id: "gallery/[album]",
      ...
      {
        type: "endpoint",
        id: "packages/[pack]/[pack].json",
        pattern: /^\/packages\/([^/]+?)\/([^/]+?)\.json$/,
        names: ["pack", "pack"],
        types: [null, null],
        load: () => Promise.resolve().then(() => (init_pack_json(), pack_json_exports))
      },
      {
        type: "endpoint",
        id: "gallery/[album]/[album].json",
        pattern: /^\/gallery\/([^/]+?)\/([^/]+?)\.json$/,
        names: ["album", "album"],
        types: [null, null],
        load: () => Promise.resolve().then(() => (init_album_json(), album_json_exports))
      }
    ],
    matchers: async () => {
      return {};
